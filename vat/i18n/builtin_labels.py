...
LABELS_ALL = {
    "English": {
        ...
        "edit_recording_ocenaudio": "Edit in Ocenaudio",
        "delete_recording_confirm_title": "Delete Recording",
        "delete_recording_confirm_body": "Delete the recording for \"{filename}\"? This cannot be undone.",
        "add_video": "Add video…",
        "add_image": "Add image…",
        "convert_to_mp4": "Convert to MP4",
        "convert_to_jpg": "Convert to JPG",
        "select_video_file_dialog": "Select Video File",
        "add_video_options": "Import Video",
        "add_video_tip": "Videos are shown in filename order. Consider putting numbers first (e.g., 001_name.mp4) to control sort order.",
        "add_image_options": "Import Image",
        "add_image_tip": "Images are shown in filename order. Consider putting numbers first (e.g., 001_name.jpg) to control sort order.",
        "name_auto_number": "Autonumber: vat_0000",
        "name_original": "Original filename & format",
        "name_custom": "Custom filename",
        "custom_filename_label": "Filename:",
        "custom_filename_placeholder": "e.g., 001_scene",
        "ok": "OK",
        "cancel": "Cancel",
        "overwrite_title": "Overwrite?",
        "file_exists_overwrite": "File already exists. Overwrite?",
        "converting_image": "Converting…",
    ...
    "Bahasa Indonesia": {
        ...
        "edit_recording_ocenaudio": "Edit di Ocenaudio",
        "delete_recording_confirm_title": "Hapus Rekaman",
        "delete_recording_confirm_body": "Hapus rekaman untuk \"{filename}\"? Tindakan ini tidak dapat dibatalkan.",
        "add_video": "Tambah video…",
        "add_image": "Tambah gambar…",
        "convert_to_mp4": "Konversi ke MP4",
        "convert_to_jpg": "Konversi ke JPG",
        "select_video_file_dialog": "Pilih File Video",
        "add_video_options": "Impor Video",
        "add_video_tip": "Video ditampilkan sesuai urutan nama file. Pertimbangkan menambahkan angka di depan (mis. 001_nama.mp4) untuk mengatur urutan.",
        "add_image_options": "Impor Gambar",
        "add_image_tip": "Gambar ditampilkan sesuai urutan nama file. Pertimbangkan menambahkan angka di depan (mis. 001_nama.jpg) untuk mengatur urutan.",
        "name_auto_number": "Penomoran otomatis: vat_0000",
        "name_original": "Nama file & format asli",
        "name_custom": "Nama file kustom",
        "custom_filename_label": "Nama file:",
        "custom_filename_placeholder": "mis. 001_adegan",
        "ok": "OK",
        "cancel": "Batal",
        "overwrite_title": "Timpa?",
        "file_exists_overwrite": "File sudah ada. Timpa?",
        "converting_image": "Mengonversi…",
        "converting_video": "Mengonversi…",
    ...
    "한국어": {
        ...
        "edit_recording_ocenaudio": "Ocenaudio에서 편집",
        "delete_recording_confirm_title": "녹음 삭제",
        "delete_recording_confirm_body": "\"{filename}\"의 녹음을 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
        "add_video": "동영상 추가…",
        "add_image": "이미지 추가…",
        "convert_to_mp4": "MP4로 변환",
        "convert_to_jpg": "JPG로 변환",
        "select_video_file_dialog": "동영상 파일 선택",
        "add_video_options": "동영상 가져오기",
        "add_video_tip": "동영상은 파일 이름 순서로 표시됩니다. 순서를 지정하려면 숫자를 앞에 붙이세요 (예: 001_이름.mp4).",
        "add_image_options": "이미지 가져오기",
        "add_image_tip": "이미지는 파일 이름 순서로 표시됩니다. 순서를 지정하려면 숫자를 앞에 붙이세요 (예: 001_이름.jpg).",
        "name_auto_number": "자동 번호: vat_0000",
        "name_original": "원본 파일명 및 형식",
        "name_custom": "사용자 지정 파일명",
        "custom_filename_label": "파일명:",
        "custom_filename_placeholder": "예: 001_장면",
        "ok": "확인",
        "cancel": "취소",
        "overwrite_title": "덮어쓰기?",
        "file_exists_overwrite": "파일이 이미 존재합니다. 덮어쓰시겠습니까?",
        "converting_image": "변환 중…",
        "converting_video": "변환 중…",
    ...
    "Nederlands": {
        ...
        "edit_recording_ocenaudio": "Bewerken in Ocenaudio",
        "delete_recording_confirm_title": "Opname verwijderen",
        "delete_recording_confirm_body": "Opname voor \"{filename}\" verwijderen? Dit kan niet ongedaan worden gemaakt.",
        "add_video": "Video toevoegen…",
        "add_image": "Afbeelding toevoegen…",
        "convert_to_mp4": "Converteren naar MP4",
        "convert_to_jpg": "Converteren naar JPG",
        "select_video_file_dialog": "Videobestand selecteren",
        "add_video_options": "Video importeren",
        "add_video_tip": "Video's worden weergegeven op volgorde van bestandsnaam. Overweeg nummers vooraan te zetten (bijv. 001_naam.mp4) om de volgorde te bepalen.",
        "add_image_options": "Afbeelding importeren",
        "add_image_tip": "Afbeeldingen worden weergegeven op volgorde van bestandsnaam. Overweeg nummers vooraan te zetten (bijv. 001_naam.jpg) om de volgorde te bepalen.",
        "name_auto_number": "Autonummering: vat_0000",
        "name_original": "Originele bestandsnaam & indeling",
        "name_custom": "Aangepaste bestandsnaam",
        "custom_filename_label": "Bestandsnaam:",
        "custom_filename_placeholder": "bijv. 001_scène",
        "ok": "OK",
        "cancel": "Annuleren",
        "overwrite_title": "Overschrijven?",
        "file_exists_overwrite": "Bestand bestaat al. Overschrijven?",
        "converting_image": "Converteren…",
        "converting_video": "Converteren…",
    ...
    "Español (Latinoamérica)": {
        ...
        "edit_recording_ocenaudio": "Editar en Ocenaudio",
        "delete_recording_confirm_title": "Eliminar grabación",
        "delete_recording_confirm_body": "¿Eliminar la grabación de \"{filename}\"? Esta acción no se puede deshacer.",
        "add_video": "Agregar video…",
        "add_image": "Agregar imagen…",
        "convert_to_mp4": "Convertir a MP4",
        "convert_to_jpg": "Convertir a JPG",
        "select_video_file_dialog": "Seleccionar archivo de video",
        "add_video_options": "Importar video",
        "add_video_tip": "Los videos se muestran en orden de nombre de archivo. Considera agregar números al inicio (ej. 001_nombre.mp4) para controlar el orden.",
        "add_image_options": "Importar imagen",
        "add_image_tip": "Las imágenes se muestran en orden de nombre de archivo. Considera agregar números al inicio (ej. 001_nombre.jpg) para controlar el orden.",
        "name_auto_number": "Autonumeración: vat_0000",
        "name_original": "Nombre de archivo y formato original",
        "name_custom": "Nombre de archivo personalizado",
        "custom_filename_label": "Nombre de archivo:",
        "custom_filename_placeholder": "ej. 001_escena",
        "ok": "Aceptar",
        "cancel": "Cancelar",
        "overwrite_title": "¿Sobrescribir?",
        "file_exists_overwrite": "El archivo ya existe. ¿Sobrescribir?",
        "converting_image": "Convirtiendo…",
        "converting_video": "Convirtiendo…",
    ...
    "Afrikaans": {
        ...
        "delete_recording": "Vee opname uit",
        "edit_recording_ocenaudio": "Redigeer in Ocenaudio",
        "delete_recording_confirm_title": "Vee opname uit",
        "delete_recording_confirm_body": "Vee die opname vir \"{filename}\" uit? Dit kan nie ongedaan gemaak word nie.",
        "add_video": "Voeg video by…",
        "add_image": "Voeg beeld by…",
        "convert_to_mp4": "Skakel om na MP4",
        "convert_to_jpg": "Skakel om na JPG",
        "select_video_file_dialog": "Kies videolêer",
        "add_video_options": "Voer video in",
        "add_video_tip": "Video's word in lêernaamvolgorde gewys. Oorweeg dit om nommers eerste te plaas (bv. 001_naam.mp4) om die volgorde te beheer.",
        "add_image_options": "Voer beeld in",
        "add_image_tip": "Beelde word in lêernaamvolgorde gewys. Oorweeg dit om nommers eerste te plaas (bv. 001_naam.jpg) om die volgorde te beheer.",
        "name_auto_number": "Outonom: vat_0000",
        "name_original": "Oorspronklike lêernaam en formaat",
        "name_custom": "Pasgemaakte lêernaam",
        "custom_filename_label": "Lêernaam:",
        "custom_filename_placeholder": "bv. 001_toneel",
        "ok": "OK",
        "cancel": "Kanselleer",
        "overwrite_title": "Oorskryf?",
        "file_exists_overwrite": "Lêer bestaan reeds. Oorskryf?",
        "converting_image": "Skakel om…",
        "converting_video": "Skakel om…",
    ...
    "Português (Brasil)": {
        ...
        "edit_recording_ocenaudio": "Editar no Ocenaudio",
        "delete_recording_confirm_title": "Excluir gravação",
        "delete_recording_confirm_body": "Excluir a gravação de \"{filename}\"? Essa ação não pode ser desfeita.",
        "add_video": "Adicionar vídeo…",
        "add_image": "Adicionar imagem…",
        "convert_to_mp4": "Converter para MP4",
        "convert_to_jpg": "Converter para JPG",
        "select_video_file_dialog": "Selecionar arquivo de vídeo",
        "add_video_options": "Importar vídeo",
        "add_video_tip": "Os vídeos são exibidos em ordem de nome de arquivo. Considere colocar números no início (ex.: 001_nome.mp4) para controlar a ordem.",
        "add_image_options": "Importar imagem",
        "add_image_tip": "As imagens são exibidas em ordem de nome de arquivo. Considere colocar números no início (ex.: 001_nome.jpg) para controlar a ordem.",
        "name_auto_number": "Autonumeração: vat_0000",
        "name_original": "Nome de arquivo e formato originais",
        "name_custom": "Nome de arquivo personalizado",
        "custom_filename_label": "Nome do arquivo:",
        "custom_filename_placeholder": "ex.: 001_cena",
        "ok": "OK",
        "cancel": "Cancelar",
        "overwrite_title": "Sobrescrever?",
        "file_exists_overwrite": "O arquivo já existe. Sobrescrever?",
        "converting_image": "Convertendo…",
